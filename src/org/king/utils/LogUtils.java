...
public class LogUtils {
	...
	public static void v(String msg) {
		if (isShowLog && priority <= VERBOSE)
			Log.v(getCallerStackLogTag(), msg);
	...
	public static void v(String msg,Throwable t) {
		if (isShowLog && priority <= VERBOSE)
			Log.v(getCallerStackLogTag(), msg, t);
	}
	...
	public static void d(String msg) {
		if (isShowLog && priority <= DEBUG)
			Log.d(getCallerStackLogTag(), msg);
	}
	...
	public static void d(String msg,Throwable t) {
		if (isShowLog && priority <= DEBUG)
			Log.d(getCallerStackLogTag(), msg, t);
	}
	...
	public static void i(String msg) {
		if (isShowLog && priority <= INFO)
			Log.i(getCallerStackLogTag(), msg);
	}
	...
	public static void i(String msg,Throwable t) {
		if (isShowLog && priority <= INFO)
			Log.i(getCallerStackLogTag(), msg, t);
	}
	...
	public static void w(String msg) {
		if (isShowLog && priority <= WARN)
			Log.w(getCallerStackLogTag(), msg);
	}
	...
	public static void w(String msg,Throwable t) {
		if (isShowLog && priority <= WARN)
			Log.w(getCallerStackLogTag(), msg, t);
	}
	...
	public static void e(String msg) {
		if (isShowLog && priority <= ERROR)
			Log.e(getCallerStackLogTag(), msg);
	}
	...
	public static void e(String msg,Throwable t) {
		if (isShowLog && priority <= ERROR)
			Log.e(getCallerStackLogTag(), msg, t);
	}
	...
	public static void wtf(String msg) {
		if (isShowLog && priority <= ASSERT)
			Log.wtf(getCallerStackLogTag(), msg);
	}
	...
	public static void wtf(String msg,Throwable t) {
		if (isShowLog && priority <= ASSERT)
			Log.wtf(getCallerStackLogTag(), msg, t);
	}
